...
class Core_Controller extends CI_Controller
{
    public function __construct()
    {
        ...
        //max file size
        $this->img_uplaod_max_file_size = 20971520;
        $this->username_maxlength = 40;
        if (empty($this->storage_settings->aws_bucket)) {
            $this->aws_base_url = "https://s3.amazonaws.com/";
        } else {
            $this->aws_base_url = "https://s3.amazonaws.com/" . $this->storage_settings->aws_bucket . "/";
        }

        $this->selected_system = $this->general_settings->selected_system;
