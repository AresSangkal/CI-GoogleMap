                                ...
                                <div class="member-list-item">
                                    <div class="left">
                                        <a href="<?php echo lang_base_url(); ?>profile/<?php echo $member->slug; ?>">
                                            <img src="<?php echo get_user_avatar($member); ?>" alt="<?php echo html_escape($member->username); ?>" class="img-fluid img-profile lazyload">
                                        </a>
                                    </div>
                                    <div class="right">
                                        <a href="<?php echo lang_base_url(); ?>profile/<?php echo $member->slug; ?>">
                                            <p class="username"><?php echo html_escape($member->username); ?></p>
                                        </a>
