                        ...
                        <div class="col-sm-12 col-lg-7">
                            <div class="left">
                                ...
                                <div class="tab-checkout tab-checkout-open">
                                    ...
                                    <?php echo form_open('promote_controller/payment_method_post', ['id' => 'form_validate']); ?>
                                    <div class="row">
                                        <div class="col-12">
                                                    ...
                                                    <?php if ($payment_settings->bank_transfer_enabled): ?>
                                                        <li>
                                                            <div class="custom-control custom-radio">
                                                                ...
                                                                <label class="custom-control-label label-payment-option" for="option_bank"><?php echo trans("bank_transfer"); ?>&nbsp;<small>(<?php echo trans("offline_payment"); ?>)</small></label>
                                                            </div>
                                                        </li>
                                                    <?php endif; ?>
                                                </ul>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox custom-control-validate-input">
                                                    <input type="checkbox" class="custom-control-input" name="terms_conditions" id="terms_conditions" required>
