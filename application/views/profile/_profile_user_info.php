        ...
        <div class="right">
            <div class="row-custom row-profile-username">
                ...
                <?php if ($general_settings->user_reviews == 1):
                    $rew_count = get_user_review_count($user->id);
                    if ($rew_count > 0):?>
                        <!--stars-->
            ...
            <div class="row-custom user-contact">
                ...
                <?php if (!empty($user->email) && $user->show_email == 1): ?>
                    &nbsp;&nbsp;<?php echo html_escape($user->email); ?>&nbsp;&nbsp;&nbsp;<i class="icon-envelope"></i>&nbsp;&nbsp;&nbsp;<span class="info"></span>

                <?php endif; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                <?php if (!empty($user->phone_number) && $user->show_phone == 1): ?>
                    <a href="javascript:void(0)" id="show_phone_number">
                        <i class="icon-phone"></i>&nbsp;&nbsp;&nbsp;<?php echo trans("show"); ?>
                    </a>
                    <a href="tel:<?php echo html_escape($user->phone_number); ?>" id="phone_number" class="display-none"><?php echo html_escape($user->phone_number); ?>
                </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span class="info">
                    </span>
                <?php endif; ?>
                <?php if (!empty(get_location($user)) && $user->show_location == 1): ?>
                <i class="icon-map-marker"></i><?php echo get_location($user); ?>
                <?php endif; ?>
