                        ...
                        <li>
                            <div class="left">
                                <a href="<?php echo lang_base_url(); ?>profile/<?php echo html_escape($review->user_slug); ?>">
                                    <img src="<?php echo get_user_avatar_by_id($review->user_id); ?>" alt="<?php echo html_escape($review->user_username); ?>">
                                </a>
                            </div>
                            <div class="right">
                                <div class="row-custom">
                                    <a href="<?php echo lang_base_url(); ?>profile/<?php echo html_escape($review->user_slug); ?>">
                                        <span class="username"><?php echo html_escape($review->user_username); ?></span>
                                    </a>
                                    <!--stars-->
