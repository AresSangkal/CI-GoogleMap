...
<?php include APPPATH . 'config/stripe.php'; ?>
<div class="row" style="margin-bottom: 15px;">
    <div class="col-sm-12">
        <h3 style="font-size: 18px; font-weight: 600;"><?php echo trans('payment_settings'); ?></h3>
    </div>
</div>
<div class="row">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="stripe_publishable_key" placeholder="<?php echo trans('publishable_key'); ?>"
                           value="<?php echo $stripe_vars['publishable_key']; ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="stripe_secret_key" placeholder="<?php echo trans('secret_key'); ?>"
                           value="<?php echo $stripe_vars['secret_key']; ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
            </div>
            <!-- /.box-body -->
            <div class="box-footer">
...
<div class="row">
    <div class="col-lg-6 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo trans('iyzico_account'); ?></h3>
            </div>
            <!-- /.box-header -->

            <!-- form start -->
            <?php echo form_open('admin_controller/iyzico_settings_post'); ?>
            <div class="box-body">
                <!-- include message block -->
    ...
    <div class="col-lg-6 col-md-12">
        <div class="box box-primary">
            ...
            <!-- form start -->
            <?php echo form_open('admin_controller/bank_transfer_settings_post'); ?>
            <div class="box-body">
                <!-- include message block -->
