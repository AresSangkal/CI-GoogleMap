                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <?php if ($order->buyer_id == 0): ?>
                            ...
                            <div class="row row-details">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?php echo $order->shipping_first_name . " " . $order->shipping_last_name; ?> <label class="label bg-olive"><?php echo trans("guest"); ?></label></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?php echo $order->shipping_phone_number; ?></strong>
                                </div>
                            </div>
                            ...
                            <div class="row row-details">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?php echo $order->shipping_email; ?></strong>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="row row-details">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->billing_first_name; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->billing_last_name; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->billing_email; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->billing_phone_number; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->billing_address_1; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->billing_address_2; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->billing_country; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->billing_state; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->billing_city; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->billing_zip_code; ?></strong>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="row row-details">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->shipping_first_name; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->shipping_last_name; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                        ...
                        <div class="row row-details">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->shipping_address_1; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->shipping_address_2; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->shipping_country; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->shipping_state; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->shipping_city; ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo $order->shipping_zip_code; ?></strong>
                            </div>
                        </div>
                    </div>
                </div>
