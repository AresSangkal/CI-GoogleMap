                                ...
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu options-dropdown" style="min-width: 190px;">
                                            ...
                                            <li>
                                                <?php if ($item->status == 1): ?>
                                                    <button type="submit" name="option" value="not_completed" class="btn-list-button">
                                            ...
                                            <li>
                                                <?php if ($item->payment_status == 'payment_received'): ?>
                                                    <button type="submit" name="option" value="payment_not_received" class="btn-list-button">
