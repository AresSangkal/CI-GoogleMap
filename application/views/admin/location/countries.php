                                ...
                                <td width="20%">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu options-dropdown">
                                            ...
                                            <li>
                                                <a href="javascript:void(0)" onclick="delete_item('admin_controller/delete_country_post','<?php echo $item->id; ?>','<?php echo trans("confirm_country"); ?>');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
