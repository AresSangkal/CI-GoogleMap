                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-xs-12 m-b-10">
                            <label><?php echo trans("product_location_system"); ?></label>
                        </div>
                        <div class="col-xs-12 col-option m-b-10">
                            <input type="radio" name="product_location_system" value="1" id="product_location_system_1"
                                   class="square-purple" <?php echo ($general_settings->product_location_system == 1) ? 'checked' : ''; ?>>
                            <label for="product_location_system_1" class="option-label"><?php echo trans("enable"); ?></label>
                        </div>
                        <div class="col-xs-12 col-option m-b-10">
                            <input type="radio" name="product_location_system" value="0" id="product_location_system_2"
                                   class="square-purple" <?php echo ($general_settings->product_location_system != 1) ? 'checked' : ''; ?>>
                            <label for="product_location_system_2" class="option-label"><?php echo trans("disable"); ?></label>
                        </div>
                    </div>
                </div>
