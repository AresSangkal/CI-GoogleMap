        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="row row-product-details">
                    ...
                    <div class="col-md-9 col-sm-12 right">
                        <?php $category = get_category_joined($product->category_id);
                        if (!empty($category)): ?>
                            <?php echo html_escape($category->name); ?>
                        <?php endif; ?>

                        <?php $category = get_category_joined($product->subcategory_id);
                        if (!empty($category)): ?>
                            <?php echo ", " . html_escape($category->name); ?>
                        <?php endif; ?>
                ...
                <div class="row row-product-details">
                    ...
                    <div class="col-md-9 col-sm-12 right">
                        <?php echo trans($product->product_condition); ?>
                    </div>
                </div>
            ...
            <div class="box-footer">
                ...
                <?php endif; ?>
                <a href="<?php echo base_url(); ?>update-product/<?php echo $product->id; ?>" target="_blank" class="btn btn-info pull-right m-r-5"><?php echo trans('edit'); ?></a>
