...
<head>
    ...
    <title><?php echo trans("email_text_thank_for_order"); ?></title>
    <style>
        /* -------------------------------------
            GLOBAL RESETS
        ------------------------------------- */
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <p style="color: #555; padding-right: 10px;">
                                                            <?php echo trans("first_name"); ?>:&nbsp;<?php echo $order->shipping_first_name; ?><br>
                                                            <?php echo trans("last_name"); ?>:&nbsp;<?php echo $order->shipping_last_name; ?><br>
                                                            <?php echo trans("email"); ?>:&nbsp;<?php echo $order->shipping_email; ?><br>
                                                            <?php echo trans("phone_number"); ?>:&nbsp;<?php echo $order->shipping_phone_number; ?><br>
                                                            <?php echo trans("address"); ?> 1:&nbsp;<?php echo $order->shipping_address_1; ?><br>
                                                            <?php echo trans("address"); ?> 2:&nbsp;<?php echo $order->shipping_address_2; ?><br>
                                                            <?php echo trans("country"); ?>:&nbsp;<?php echo $order->shipping_country; ?><br>
                                                            <?php echo trans("state"); ?>:&nbsp;<?php echo $order->shipping_state; ?><br>
                                                            <?php echo trans("city"); ?>:&nbsp;<?php echo $order->shipping_city; ?><br>
                                                            <?php echo trans("zip_code"); ?>:&nbsp;<?php echo $order->shipping_zip_code; ?><br>
                                                        </p>
                                                    </td>
                                                    <td>
                                                        <h3 style="margin-bottom: 10px; font-size: 16px;font-weight: 600;"><?php echo trans("billing_address"); ?></h3>
                                                        <p style="color: #555; padding-right: 10px;">
                                                            <?php echo trans("first_name"); ?>:&nbsp;<?php echo $order->billing_first_name; ?><br>
                                                            <?php echo trans("last_name"); ?>:&nbsp;<?php echo $order->billing_last_name; ?><br>
                                                            <?php echo trans("email"); ?>:&nbsp;<?php echo $order->billing_email; ?><br>
                                                            <?php echo trans("phone_number"); ?>:&nbsp;<?php echo $order->billing_phone_number; ?><br>
                                                            <?php echo trans("address"); ?> 1:&nbsp;<?php echo $order->billing_address_1; ?><br>
                                                            <?php echo trans("address"); ?> 2:&nbsp;<?php echo $order->billing_address_2; ?><br>
                                                            <?php echo trans("country"); ?>:&nbsp;<?php echo $order->billing_country; ?><br>
                                                            <?php echo trans("state"); ?>:&nbsp;<?php echo $order->billing_state; ?><br>
                                                            <?php echo trans("city"); ?>:&nbsp;<?php echo $order->billing_city; ?><br>
                                                            <?php echo trans("zip_code"); ?>:&nbsp;<?php echo $order->billing_zip_code; ?><br>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table>
