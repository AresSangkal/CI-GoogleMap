                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            ...
                                            <h3 style="margin-bottom: 10px;font-size: 16px;font-weight: 600;border-bottom: 1px solid #d1d1d1;padding-bottom: 5px; margin-top: 45px;"><?php echo trans("shipping_information"); ?></h3>
                                            <p><?php echo trans("tracking_number"); ?>:&nbsp;<?php echo $order_product->shipping_tracking_number; ?></p>
                                            <p><?php echo trans("url"); ?>:&nbsp;<a href="<?php echo html_escape($order_product->shipping_tracking_url); ?>" target="_blank" class="link-underlined"><?php echo html_escape($order_product->shipping_tracking_url); ?></a></p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
