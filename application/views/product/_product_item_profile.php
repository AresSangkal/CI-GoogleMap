        ...
        <div class="col-8">
            ...
            <div class="row-custom m-t-10">
                <?php if (!$product->is_promoted && $promoted_products_enabled == 1): ?>
                    <a href="<?php echo lang_base_url() . "promote-product/pricing/" . $product->id; ?>?type=exist" class="btn btn-sm btn-outline-gray m-r-1"><i class="icon-plus"></i>&nbsp;<?php echo trans("promote"); ?></a>
                <?php endif; ?>
                <?php if ($product->is_sold == 1): ?>
                ...
                <?php endif; ?>
                <a href="<?php echo lang_base_url() . "update-product/" . $product->id; ?>" class="btn btn-sm btn-outline-gray btn-profile-option m-r-2"><i class="icon-edit"></i>&nbsp;<?php echo trans("edit"); ?></a>
                <a href="javascript:void(0)" class="btn btn-sm btn-outline-gray btn-profile-option" onclick="delete_product(<?php echo $product->id; ?>,'<?php echo trans("confirm_product"); ?>');"><i class="icon-times"></i>&nbsp;<?php echo trans("delete"); ?></a>
            </div>
        </div>
    </div>
</div>
