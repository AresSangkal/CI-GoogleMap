...
class Home_controller extends Home_Core_Controller
{
    ...
    */
    ...
    public function blog()
    {
        ...
        $data["blog_settings"] = get_blog_settings();
    ...
    //get sub categories by lang
    public function get_subcategories_by_lang()
    {
        $id = $this->input->post('parent_id', true);
        $data["lang_id"] = $this->input->post('lang_id', true);
        $data["subcategories"] = null;
        if ($id != 0) {
            $data["subcategories"] = $this->category_model->get_subcategories_by_parent_id_by_lang($id, $data["lang_id"]);
        }
        $this->load->view('product/_response_subcategories', $data);
    }

    //get subcategories by lang
    public function get_third_categories_by_lang()
    {
        $id = $this->input->post('parent_id', true);
        $data["lang_id"] = $this->input->post('lang_id', true);
        $data["subcategories"] = null;
        ...
        $this->load->view('product/_response_third_categories', $data);
    }
