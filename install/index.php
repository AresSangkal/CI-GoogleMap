...
if (isset($_POST["btn_license_code"])) {
    ...
    if (!empty($data)) {
        if ($data->code == "error") {
            ...
            $variables = update_config_license_code($license_code);
        } else {
            $purchase_code = $data->code;
            $variables = update_config_license($license_code, $purchase_code);
                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="license_code" class="form-control form-input" style="resize: vertical; height: 100px;line-height: 24px;padding: 10px;" placeholder="Enter License Code" required><?php echo @$variables['license_code']; ?></textarea>
                                            </div>
